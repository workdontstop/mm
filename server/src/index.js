...
app.post("/upload", upload.array("final", 8), (req, res, next) =>
...
app.post("/feeds_chronological", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const connection = mysql.createConnection(CONNECTION_CONFIG);
...
app.post("/keepmeloggedin", validateToken, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
app.post("/checkIsLogged", validateToken, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (req.cookies.accesst) {
      const userSessionData = jwt_decode_1.default(req.cookies.accesst);
      const connection = mysql.createConnection(CONNECTION_CONFIG);
  ...
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (!validateErrors.isEmpty()) {
        ...
        const connection = mysql.createConnection(CONNECTION_CONFIG);
        const checkpassQuery = util.promisify(
          connection.query.bind(connection)
        );
        try {
    ...
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (!validateErrors.isEmpty()) {
        ...
        try {
          ...
          const PasswordMatchResult = yield bcrypt.compare(
  ...
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (!validateErrors.isEmpty()) {
        ...
        const connection = mysql.createConnection(CONNECTION_CONFIG);
        const execQuery = util.promisify(connection.query.bind(connection));
        bcrypt.hash(values.inputedPassword, 10).then((hash) =>
          __awaiter(void 0, void 0, void 0, function* () {
            try {
